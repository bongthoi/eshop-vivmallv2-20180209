$(function () {	 
	...
	tinymce.init({
		  selector: '#ProductInfo,#ProductGuide,#ProductDes',
		  height: 300,
	...
	$("#btnsaveproduct").click(function(){
			//var pdata=$("#frm-about").serialize();
					var MCEeditor1=tinymce.get('ProductGuide');
					var content1=MCEeditor1.getContent();		
					$("#ProductGuide").val(content1);
					
					var MCEeditor2=tinymce.get('ProductInfo');
					var content2=MCEeditor2.getContent();		
					$("#ProductInfo").val(content2);
					
					var MCEeditor3=tinymce.get('ProductDes');
					var content3=MCEeditor3.getContent();		
					$("#ProductDes").val(content3);
