...
import vivmallcn.domain.UserRole;
import vivmallcn.domain.frmChangePassword;
import vivmallcn.repository.UserRepository;
import vivmallcn.repository.UserRoleRepository;
...
public class IUserImpl implements IUser {
	...
	@Override
	public Long getNewUserSize() {
		// TODO Auto-generated method stub
		return userRepository.getNewUserSize();
	}
	@Override
	public Page<User> findNewUsersByIsEnabled(int enabled, Pageable page) {
		// TODO Auto-generated method stub
		return userRepository.findNewUsersByIsEnabled(enabled,page);
	}
	@Override
