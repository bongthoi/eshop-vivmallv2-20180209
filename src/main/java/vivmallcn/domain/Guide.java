...
public class Guide implements Persistable<String>{

	
	/**
	 * 
	 */
	private static final long serialVersionUID = 1790650649575763103L;
	...
	public Guide(String id, String title, String description, String logo,
